...
//        });		
	...
	public OrderView() throws Exception {
		...
		contentPane.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "발 주 서", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
...
//		table = new JTable(tm);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
					"업 체 명", "프로젝트명", "발주 내용", "수 량", "금 액", "날 짜", "담 당 자", "전화 번호", "e-mail"
			}
		) {
	       ...
	       textField = new JTextField();
	        ...
	        textField.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                try {
	                    OrderVO orderVO = dao.companyname(pa_company);

	                    textField.setText(orderVO.getPa_company());
	                    textField_6.setText(orderVO.getPa_dam());
	                    textField_7.setText(orderVO.getPa_tel());
	                    textField_8.setText(orderVO.getPa_email());
	                } catch (Exception ex) {
	                    ex.printStackTrace();
	                }
	            }
		...
		JLabel lblNewLabel_1 = new JLabel("발주내용");		
		...
		textField_5.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        String om_contents = textField_2.getText();
		        int om_count = Integer.parseInt(textField_3.getText());
		        int om_amount = Integer.parseInt(textField_4.getText());
		        String om_date = textField_5.getText();
		        ...
		        data = new Object[]{pa_company, pro_name, om_contents, om_count, om_amount, om_date, pa_dam, pa_tel, pa_email};
		        dataList.add(data);
	        ...
	        e.printStackTrace(); // 예외 처리
			    ...
			    comboBox_1.addActionListener(new ActionListener() {
			        public void actionPerformed(ActionEvent e) {
			            ...
			            try {
			                // 선택된 사업관리번호로 OrderDAO에서 정보 조회
			                OrderVO vo = dao.findBmno(selectedBmNo);
		
			                // 프로젝트명 조회
			                OrderVO projectVO = dao.findProjectName(selectedBmNo);
		...
		Button button_1 = new Button("발주내역저장");
		...
		button_1.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        try {
		            ...
		            String om_contents = (String) data[2];
		            int om_count = (int) data[3];
		            int om_amount = (int) data[4];
		            String om_date = (String) data[5];
		            ...
		            dao.insertOrder(om_contents, om_count, om_amount, om_date, bm_no, part_no);
			        clearTable();
